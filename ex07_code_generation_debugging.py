...
AIM
    To develop an AI-powered assistant that generates code from
    natural-language descriptions and helps identify/fix bugs in existing
    code using a pre-trained code-generation model.
