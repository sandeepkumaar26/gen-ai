#!/usr/bin/env python3
"""
Ex. No: 10 - FINE-TUNING A PRE-TRAINED LANGUAGE MODEL FOR A
             DOMAIN-SPECIFIC APPLICATION

AIM
    To fine-tune a pre-trained language model (DistilBERT) on a
    domain-specific labelled dataset for a text-classification task.

REQUIREMENTS
    pip install transformers datasets torch scikit-learn
    A GPU-enabled environment is recommended (Google Colab).
"""
